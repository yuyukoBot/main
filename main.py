...
async def help(ctx):
    ...
    e3 = discord.Embed(title="<:outline_settings_black_18dp:809104587482988564>Moderation<:outline_settings_black_18dp:809104587482988564>", color=0x5d00ff).add_field(name="モデレーション機能です", value="Page 3")
