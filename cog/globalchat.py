...
class GlobalChat(commands.Cog):
    ...
    async def globalchatstart(self, ctx, channel):
        ...
        with open('.\\database\\global_chat.json', 'r') as file:
            ...
            # Add new global chat
                ...
                with open('.\\database\\global_chat.json', 'w') as new_global_chat:
    ...
    async def globalchatstop(self, ctx):
        ...
        # Update global chat
        with open('.\\database\\global_chat.json', 'w') as update_global_chat_file:
                ...
                if message.channel.id in channel_id:
                    ...
                    for ids in channel_id:
                        if message.channel.id != ids:
                            ...
                            message_embed.description = f'**```メッセージ内容: {message.content}```**'
